...
# --
setwd(paste('/e/07/orchdhlth/Sequencing_Analysis_Tools/ginkgo/scripts', userID, sep=''))
maxPloidy = 6
...
normal2 = normal
#
GC = read.table(paste("/e/07/orchdhlth/Sequencing_Analysis_Tools/ginkgo/genomes/", genome, "/", pseudoautosomal, "/GC_", bm, sep=""), header=FALSE, sep="\t", as.is=TRUE)
#
bounds = read.table(paste("/e/07/orchdhlth/Sequencing_Analysis_Tools/ginkgo/genomes/", genome, "/", pseudoautosomal, "/bounds_", bm, sep=""), header=FALSE, sep="\t")
